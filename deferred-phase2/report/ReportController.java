...
@Tag(name = "Reports", description = "Ringkasan penjualan")
public class ReportController {

    private final ReportService reportService;

    @GetMapping("/summary")
    @Operation(summary = "Ringkasan penjualan: gross sales, jumlah transaksi, produk terlaris. Default 7 hari terakhir.")
    public SalesSummaryResponse summary(
        ...
        return reportService.summary(principal.getStoreId(), resolvedFrom, resolvedTo);
    }
}
